...
<parameter name="selectedTemeCautare" value="sub_show" />
...
<body>
	...
	<table id="twoColumns">
		<tr>
			...
			<td id="leftColumn"><tmpl:/templates/list model="[instanceList: instanceList, fieldNameList: fieldNameList, fieldList: fieldList]" /></td>
